...
<div class="sec-banner bg0 p-t-80 p-b-50">
    <div class="container">
        <div class="row">
            @php
                $menuImages = [
                    41 => '/template/images/bodycare.jpg',
                    39 => '/template/images/make.jpg',
                    38 => '/template/images/skin.jpg',
                ];
            @endphp
            @foreach($menus as $menu)
                <div class="col-md-6 col-xl-4 p-b-30 m-lr-auto">
                    ...
                    <div class="block1 wrap-pic-w">
                        <img src="{{ $menuImages[$menu->id] ?? '/template/images/default.jpg' }}" alt="{{ $menu->name }}"
                            style="width: 100%; height: 250px; object-fit: cover;">
                        <a href="/danh-muc/{{ $menu->id }}-{{ \Str::slug($menu->name, '-') }}.html"
                            style="color: white; text-decoration: none;"
                            class="block1-txt ab-t-l s-full flex-col-l-sb p-lr-38 p-tb-34 trans-03 respon3">
                            <div class="block1-txt-child1 flex-col-l" style="color: white;">
                            ...
                            <div class="block1-txt-child2 p-b-4 trans-05" style="color: white;">
