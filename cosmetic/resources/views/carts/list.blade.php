                                ...
                                <div class="size-100 p-r-18 p-r-0-sm w-full-ssm">
                                    ...
                                    <div class="p-t-15">
                                        ...
                                        <div class="bor8 bg0 m-b-12">
                                            <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="name" placeholder="Enter your name" required>
                                        </div>
                                        ...
                                        <div class="bor8 bg0 m-b-12">
                                            <textarea class="stext-111 cl8 plh3 size-111 p-lr-15" name="content" placeholder="Note"></textarea>
                                        </div>
