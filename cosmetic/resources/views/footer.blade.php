        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <p class="stext-107 cl7 size-201">
                    Any questions? Let us know by calling us on (+84) 375866804
                </p>
            ...
            <div class="col-sm-6 col-lg-3 p-b-50">
                ...
                <form>
                    <div class="wrap-input1 w-full p-b-4">
                        <input class="input1 bg-none plh1 stext-107 cl7" type="text" name="email" placeholder="ntphuoganh@gmail.com">
